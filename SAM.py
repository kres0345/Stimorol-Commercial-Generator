...
try:
    ...
    UpdateLibraryFailed = True
sys.stdout = save_stdout

if(UpdateLibraryFailed):
    print("Something went wrong installing/updating library\n")
else:
    print("Done installing/updating library.\n")
...
print("\nReading sentence structure from learning material\n")
...
print("\nBuilding sentences based on learning material\n")
